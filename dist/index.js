...
const core = __nccwpck_require__(69);
const github = __nccwpck_require__(197);

const { debug, formatLineNumbers } = __nccwpck_require__(932);
...
const { debug } = __nccwpck_require__(932);
const {
  Variables,
  getOpenPullRequests,
  getChangedFiles,
